...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost','192.168.109.47']  # Ganti dengan IP lokal perangkat Anda.
...
MIDDLEWARE = [
    ...
    'attendance_system_facial_recognition.network_middleware.NetworkValidationMiddleware',
]
